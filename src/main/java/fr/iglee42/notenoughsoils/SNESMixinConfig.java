...
public class SNESMixinConfig implements IMixinConfigPlugin{
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.contains("mystical")) return ModList.get().isLoaded("mysticalagriculture");
        if (mixinClassName.contains("mscustomization")) return ModList.get().isLoaded("mysticalcustomization");
        return true;
    }
