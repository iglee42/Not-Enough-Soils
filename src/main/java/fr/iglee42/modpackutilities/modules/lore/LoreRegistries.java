...
public class LoreRegistries {
    ...
    public static final RegistryObject<LoreEntityBlock> LORE_BLOCK = BLOCKS.register("lore_entity_block", () -> new LoreEntityBlock(Block.Properties.copy(Blocks.NETHERITE_BLOCK)));
